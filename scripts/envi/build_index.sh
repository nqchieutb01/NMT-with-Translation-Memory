...
dataset=${MTPATH}/envi
ckpt_folder=envi/ckpt.exp.pretrain/epoch19_batch99999_acc0.99
echo ${ckpt_prefix}/${ckpt_folder}
python3 build_index.py \
        --input_file ${dataset}/train_rmd.vi \
...
cp ${dataset}/train_rmd.vi ${ckpt_prefix}/${ckpt_folder}/candidates.txt
